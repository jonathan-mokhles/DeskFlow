...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.SLASetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.Ticket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.TicketAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.TicketAuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.TicketComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.IdentityEntity.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.Category", b =>
                {
                    b.HasOne("DeskFkow.Core.Domain.Entity.Department", "Department")
                        .WithMany()
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.Department", b =>
                {
                    b.HasOne("DeskFkow.Core.Domain.IdentityEntity.ApplicationUser", "Manager")
                        .WithMany()
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.SLASetting", b =>
                {
                    b.HasOne("DeskFkow.Core.Domain.Entity.Category", null)
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.Ticket", b =>
                {
                    b.HasOne("DeskFkow.Core.Domain.IdentityEntity.ApplicationUser", "AssignedTo")
                        .WithMany()
                        .HasForeignKey("AssignedToId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("DeskFkow.Core.Domain.Entity.Category", "Category")
                        .WithMany("Tickets")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DeskFkow.Core.Domain.IdentityEntity.ApplicationUser", "LastModifiedBy")
                        .WithMany()
                        .HasForeignKey("LastModifiedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DeskFkow.Core.Domain.IdentityEntity.ApplicationUser", "ReportedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.TicketAttachment", b =>
                {
                    b.HasOne("DeskFkow.Core.Domain.Entity.Ticket", "Ticket")
                        .WithMany("Attachments")
                        .HasForeignKey("TicketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DeskFkow.Core.Domain.IdentityEntity.ApplicationUser", "UploadedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.TicketAuditLog", b =>
                {
                    b.HasOne("DeskFkow.Core.Domain.IdentityEntity.ApplicationUser", "ChangedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("DeskFkow.Core.Domain.Entity.TicketComment", b =>
                {
                    ...
                    b.HasOne("DeskFkow.Core.Domain.IdentityEntity.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DeskFkow.Core.Domain.IdentityEntity.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
